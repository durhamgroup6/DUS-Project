            ...
            <div class="collapse navbar-collapse" id="exCollapsingNavbar">
                <ul class="nav navbar-nav">
                    ...
                    if (isset($_SESSION["user"]) && $_SESSION["user"] != null) {
                        ...
                        echo '<li class="nav-item active"><a href="mybooking.php">My Bookings</a></li><li class="nav-item"><a href="PersonalDetail.php">Personal Detail</a></li><li class="nav-item"><a href="php/logout.php">Logout</a></li>';
                    } else {
