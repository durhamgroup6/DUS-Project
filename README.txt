...
3.Execute this project by the php compiler or put this project folder into your sever's folder named as htdocs and then enter localhost/"this project's folder's name" in your web browser
